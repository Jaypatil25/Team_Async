...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Credify - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Credify - React.js Tailwind CSS Admin Dashboard Template"
      />
