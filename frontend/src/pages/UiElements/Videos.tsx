...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Credify - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Credify - React.js Tailwind CSS Admin Dashboard Template"
      />
